  ...
  return (
    <>
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        className="fixed bottom-[5.5rem] right-6 z-[200] w-14 h-14 bg-accent hover:bg-accent/90 text-primary rounded-full shadow-xl flex items-center justify-center relative transition-colors"
