...
export default function PdfPreviewModal({
  ...
  const handleDownload = async () => {
    try {
      ...
      a.download = cleanFileName.toLowerCase().endsWith(".pdf")
        ? cleanFileName
        : `${cleanFileName}.pdf`;
          ...
          {loadError && (
            <div className="absolute inset-0 flex flex-col items-center justify-center p-6 text-center bg-background space-y-3">
              ...
              <p className="text-xs text-muted-foreground max-w-sm">
                আপনার ব্রাউজার সিকিউরিটি বা মোবাইল ডিভাইস সরাসরি ইন-লাইন পিডিএফ সমর্থন না করতে পারে। নিচের বাটন চেপে ফাইলটি সরাসরি দেখুন বা ডাউনলোড করুন।
              </p>
